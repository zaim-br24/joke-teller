...
async function getJoke(){
    ...
    try {
       ...
       if(data.setup){
        ...
        // disabled button
        // button.disabled = true  //// how I did it
        toggoleButton()
        // text-to-speech
       tellMeJoke(joke)
    } catch (error) {
        console.log("whoooooooops error :" + error)
    }
...
audioElement.addEventListener('ended',toggoleButton)
 //// how I did it
// audioElement.addEventListener('ended', ()=> button.disabled = true? button.disabled = false :button.disabled = true)   
